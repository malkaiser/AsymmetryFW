...
histogramContainer delta_phiContainer{"delta_phi","Delta phi between tau and lep",32,0,3.2,notFull};
...
histogramContainer lepEtaContainer{"lepEta","Lepton Eta",60,-3,3,notFull};
histogramContainer tauEtaContainer{"tauEta","Tau Eta",60,-3,3,notFull};

histogramContainer tau_rnn_scoreContainer{"tau_rnn_score","RNN Score all taus",100,0,1,notFull}; // rnnscore
histogramContainer sigma_cos_del_phiContainer{"sigma_cos_del_phi","Sum of cos delta phi",100,-2,2,cutNames,"sigmacosdelphi"}; // sigma cos delta phi
histogramContainer m3_starContainer{"m3_star","Novel selection m3_star",120,0,120,notFull}; //m3_star
histogramContainer m_visContainer{"m_vis", "Visible mass of dilepton",100,0,100,notFull};
histogramContainer mWTContainer{"mWT","Reconstructed W transverse mass",120,0,120,cutNames,"mWT"}; // mWT
histogramContainer mETContainer{"mET","Reconstructed missing transverse energy",120,0,120,cutNames,"mET"}; // mET
