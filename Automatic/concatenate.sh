...
hadd gg_Higgs.root ggH*.root WmH*.root ZHlltautau*.root ZHllbb*.root
...
hadd VBF_PoPy.root VBF_Zee_201*.root VBF_Zmumu_201*.root VBF_Ztautau_201*.root VBFH*.root W_EWK_PoPy*.root
